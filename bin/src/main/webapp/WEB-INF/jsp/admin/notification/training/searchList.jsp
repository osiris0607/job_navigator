	...
	function searchListCB(data) {
		...
		if (total == 0) {
			...
			$.each(data.result, function(key, value) {
				str += "<tr>";
				str += "	<td>" + index + "</td>";
				str += "	<td><a href='/admin/rdt/notification/training/detail?training_id=" + value.training_id + "'>" + value.title + "</a></td>";
		...
		<div class="sub-content-box bgc-white">
                  ...
                  <div class="list_search_end_box clearfix">
                      ...
                      <div class="fr training_table_top_seach">
                          ...
                          <a href="/admin/rdt/notification/training/registration" class="btn blue_btn fr">등록</a>
                      </div>
