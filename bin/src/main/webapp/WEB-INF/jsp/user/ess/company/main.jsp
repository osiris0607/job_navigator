...
<script type='text/javascript'>
		...
		$.each(companyList, function(key, value) {
			if (value.company_id == id){
				...
				if ( gfn_isNull(value.associated_job_1) == false ) {
					...
					str += "		<a href='/user/rdt/solar/jobDictionary/detail?job_id=" + value.associated_job_1 + "' class='btn_detail' target='_blank'>상세보기 <i class='fa fa-angle-right' aria-hidden='true'></i></a>";
					str += "	</div>";
				}
				...
				if ( gfn_isNull(value.associated_job_2) == false ) {
					...
					str += "		<a href='/user/rdt/solar/jobDictionary/detail?job_id=" + value.associated_job_2 + "' class='btn_detail' target='_blank'>상세보기 <i class='fa fa-angle-right' aria-hidden='true'></i></a>";
					str += "	</div>";
				}
				...
				if ( gfn_isNull(value.associated_job_3) == false ) {
					...
					str += "		<a href='/user/rdt/solar/jobDictionary/detail?job_id=" + value.associated_job_3 + "' class='btn_detail' target='_blank'>상세보기 <i class='fa fa-angle-right' aria-hidden='true'></i></a>";
					str += "	</div>";
				}
	...
	function searchList(pageNo) {
		var comAjax = new ComAjax();
		comAjax.setUrl("<c:url value='/user/api/solar/company/search/paging' />");
...
<div id="wrap">
    <section>
      <div class="subVisual map">
        <div class="titleArea">
          <h2>태양광산업 기업 지도</h2>
          	<span>생태계별 태양광산업 기업을 지도 형식으로 표시하여<br /> 지역별 태양광산업 기업의 분포를 확인 가능합니다.</span>
        </div>
      </div>
    </section>
  ...
  <div class="wrap">
    ...
    <div class="contents">
      <div class="bizTitle">
        ...
        <p class="summary" id="company_category">코드분류 : D. 태양광 발전사업 > D.1. 사업개발/컨설팅</p>
      </div>
