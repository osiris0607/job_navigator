    ...
    <section class="navi_index_box_area" id="navi_index_menu">
		...
		<div class="navi_index_box">
			<ul class="navi_index clearfix">
				...
				<li><a href="javascript:alert('개발중입니다. 현재는 태양광 산업 ddddddddddd 내비게이터만 이용이 가능합니다.');" class="energyclass_menu_ess" title="Ess 바로가기" target="_self">&nbsp;<span>&nbsp;</span>Ess 바로가기</a></li>
