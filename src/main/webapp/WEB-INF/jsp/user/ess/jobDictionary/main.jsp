...
<script type='text/javascript'>
	...
	function searchList(pageNo) {
		...
		comAjax.setUrl("<c:url value='/user/api/ess/job/search/paging' />");
	...
	function searchListCB(data) {
		...
		if (total == 0) {
			...
			$.each(data.result, function(key, value) {
				...
				str += "	</dl>";
				str += "	<a href='/user/rdt/ess/jobDictionary/detail?job_id=" + value.job_id + "'>상세보기 <i class='fa fa-angle-right' aria-hidden='true'></i></a>";
				str += "</li>";
			});
			body.append(str);
		}
