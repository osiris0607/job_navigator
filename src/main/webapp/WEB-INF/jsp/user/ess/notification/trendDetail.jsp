...
<script type='text/javascript'>
	...
	function getDetailCB(data){
		...
		if (data.result.upload_file_name != null && data.result.upload_file_name != "") {
			...
			$("#attach_file_name").attr("href", "/user/api/ess/trend/download/"+ data.result.upload_file_id);
		} 
	...
	function fnSetPreNextCallback(data) {
		...
		if (data.result.pre != null) {
			$("#pre").attr("href", "/user/rdt/ess/notification/trend/detail?trend_id=" + data.result.pre.trend_id);
			$("#pre").html(data.result.pre.title);
		}
		
		if (data.result.next != null) {
			$("#next").attr("href", "/user/rdt/ess/notification/trend/detail?trend_id=" + data.result.next.trend_id);
 ...
 <section>
  ...
  <section>
    <div class="subWrap">
      ...
      <div class="btnWrap">
        <a href="/user/rdt/ess/notification/trend" class="btn viewList">목록보기</a>
      </div>
    </div>
  </section>
</div>
