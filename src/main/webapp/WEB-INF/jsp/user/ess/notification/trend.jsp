...
<script type='text/javascript'>
	...
	function searchList(pageNo) {
		...
		comAjax.setUrl("<c:url value='/user/api/ess/notification/trend/search/paging' />");
	...
	function searchListCB(data) {
		...
		if (total == 0) {
			...
			$.each(data.result, function(key, value) {
				str += "<tr>";
				str += "	<td>" + index + "</td>";
				str += "	<td><a href='/user/rdt/ess/notification/trend/detail?trend_id=" + value.trend_id + "'>" + value.title + "</a></td>";
