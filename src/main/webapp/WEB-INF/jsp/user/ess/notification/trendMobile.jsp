...
<script type='text/javascript'>
	...
	function searchList(pageNo) {
		...
		comAjax.setUrl("<c:url value='/user/api/ess/notification/trend/search/all' />");
	...
	function searchListCB(data) {
		...
		if (total == 0) {
			...
			$.each(data.result, function(key, value) {
				str += "<tr>";
				str += "	<td><a href='/user/rdt/ess/notification/trend/detailMobile?trend_id=" + value.trend_id + "'>" + value.title + "</a></td>";
