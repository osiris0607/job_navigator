...
<script type='text/javascript'>
	...
	function getJobTopList() {
		var comAjax = new ComAjax();
		comAjax.setUrl("<c:url value='/admin/api/ess/jobTop/all' />");
	...
	function confirm() {
		...
		$.ajax({
		    type : "POST",
		    url : "/admin/api/ess/jobTop/useYN",
		    data :{
		    	"job_id" : jobId,
		    	"ranking" : "Y"
		    },
...
<div class="page-nation container">
    <a href="//essrdt/ess/home/management"><i class="nav-icon fa fa-home mr5"></i>홈화면</a><span class="route_icon"></span>
