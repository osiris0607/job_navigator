...
<script type='text/javascript'>
	...
	function getJobDetail() {
		...
		comAjax.setUrl("<c:url value='/admin/api/ess/job/detail'/>");
	...
	function modification() {
		...
		if (confirm('수정 하시겠습니까?')) {
			$.ajax({
			    type : "POST",
			    url : "/admin/api/ess/job/modification",
			    data : formData,
			    processData: false,
			    contentType: false,
	...
	function withdrawal() {
		if (confirm('삭제 하시겠습니까?')) {
			$.ajax({
			    type : "POST",
			    url : "/admin/api/ess/job/withdrawal",
...
<div class="page-nation container">
    ...
    <a href="/admin/rdt/ess/job/search">일자리</a><span class="route_icon"></span>
			...
			<div class="sub-content-box bgc-white">
			    <!--기본 정보-->
                   ...
                   <div class="job_retouch_btns-box">
                        ...
                        <div class="fr">
                            <a href="/admin/rdt/ess/job/search" class="gray_btn list_back_btn btn">목록</a>
