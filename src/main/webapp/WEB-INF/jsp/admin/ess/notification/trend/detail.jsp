...
<script type='text/javascript'>
	...
	function getLicenseDetail() {
		...
		comAjax.setUrl("<c:url value='/admin/api/ess/notification/trend/search/detail'/>");
	...
	function modification() {
		...
		if (confirm('수정 하시겠습니까?')) {
			$.ajax({
			    type : "POST",
			    url : "/admin/api/ess/notification/trend/modification",
			    data : formData,
			    processData: false,
			    contentType: false,
			    ...
			    success : function(data) {
			        ...
			        if (jsonData.result == 1) {
			            alert("수정 되었습니다.");
			            location.href = "/admin/rdt/ess/notification/trend/searchList";
			        } else {
	...
	function withdrawal() {
		...
		if (confirm('삭제 하시겠습니까?')) {
			$.ajax({
			    type : "POST",
			    url : "/admin/api/ess/notification/trend/withdrawal",
			    data : formData,
			    processData: false,
			    contentType: false,
			    mimeType: 'multipart/form-data',
...
<div class="sub-content-box bgc-white">             
            ...
            <table class="job_write">
             ...
             <div class="industry-trend-view_btns">
                ...
                <div class="fr">
                    <a href="/admin/rdt/ess/notification/trend/searchList" class="gray_btn btn list_back_btn">목록</a>
