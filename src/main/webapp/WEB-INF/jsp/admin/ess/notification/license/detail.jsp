...
<script type='text/javascript'>
	...
	function getLicenseDetail() {
		...
		comAjax.setUrl("<c:url value='/admin/api/ess/notification/license/search/detail'/>");
	...
	function modification() {
		...
		if (confirm('수정 하시겠습니까?')) {
			$.ajax({
			    type : "POST",
			    url : "/admin/api/ess/notification/license/modification",
			    data : formData,
			    processData: false,
			    contentType: false,
	...
	function withdrawal() {
		...
		if (confirm('삭제 하시겠습니까?')) {
			$.ajax({
			    type : "POST",
			    url : "/admin/api/ess/notification/license/withdrawal",
			    data : formData,
			    processData: false,
			    contentType: false,
			    mimeType: 'multipart/form-data',
...
<div class="page-nation container">
    ...
    <a href="/admin/rdt/ess/notification/license/searchList">교육기관&middot;훈련과정</a><span class="route_icon"></span>
		...
		<div class="sub-content-box bgc-white"> 
           ...
           <table class="job_write">
            ...
            <div class="industry-trend-view_btns">
                ...
                <div class="fr">
                    <a href="/admin/rdt/ess/notification/license/searchList" class="gray_btn list_back_btn btn">목록</a>
