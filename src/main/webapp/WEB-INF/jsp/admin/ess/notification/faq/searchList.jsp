...
<script type='text/javascript'>
	...
	function searchList(pageNo) {
		...
		comAjax.setUrl("<c:url value='/admin/api/ess/notification/faq/search/paging' />");
	...
	function searchListCB(data) {
		...
		if (total == 0) {
			...
			$.each(data.result, function(key, value) {
				str += "<li>";
				str += "	<a href='/admin/rdt/ess/notification/faq/detail?faq_id=" + value.faq_id + "' class='clearfix'>";
...
<!--리스트 검색 상단-->				
		<div class="sub-content-box bgc-white">
          	<div class="faq-center_table_top_seach clearfix">
                  ...
                  <a href="/admin/rdt/ess/notification/faq/registration" class="btn blue_btn fr">등록</a>
              </div>
              <!--리스트 상단 검색결과-->		
