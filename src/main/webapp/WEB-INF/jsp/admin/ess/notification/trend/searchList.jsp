...
<script type='text/javascript'>
	...
	function searchList(pageNo) {
		...
		comAjax.setUrl("<c:url value='/admin/api/ess/notification/trend/search/paging' />");
	...
	function searchListCB(data) {
		...
		if (total == 0) {
			...
			$.each(data.result, function(key, value) {
				str += "<tr>";
				str += "	<td>" + index + "</td>";
				str += "	<td><a href='/admin/rdt/ess/notification/trend/detail?trend_id=" + value.trend_id + "'>" + value.title + "</a></td>";
...
<div class="page-nation container">
    <a href="/admin/rdt/ess/ess/home/management"><i class="nav-icon fa fa-home mr5"></i>홈화면</a><span class="route_icon"></span>
                 ...
                 <!--리스트 상단 검색결과-->                
                  <div class="list_search_end_box clearfix">
                      ...
                      <div class="fr industry-trend_table_top_seach clearfix">
                          ...
                          <a href="/admin/rdt/ess/notification/trend/registration" class="btn blue_btn fr">등록</a>
                      </div>
