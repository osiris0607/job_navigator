  ...
  function callApiData(playlist, value) {
		...
		$.getJSON("https://www.googleapis.com/youtube/v3/videos", {
			...
			*/
			...
			output = '<a class="videoTitle" href="/admin/rdt/ess/notification/online/detail?online_id='+value.online_id+'">'+value.title+'</a><p class="videoSummary">' + vCount + ' views ' + vDateFormat + '</p>' + 
