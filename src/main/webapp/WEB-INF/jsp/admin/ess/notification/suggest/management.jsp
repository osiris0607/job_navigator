...
<script type='text/javascript'>
	...
	function searchList(pageNo) {
		...
		comAjax.setUrl("<c:url value='/admin/api/ess/notification/suggest/all' />");
	...
	function useYN(id, index) {
		...
		if (confirm('변경 하시겠습니까?')) {
			$.ajax({
			    type : "POST",
			    url : "/admin/api/ess/notification/suggest/useYN",
			    data :{
			    	"suggest_id" : id,
			    	"use_yn" : flag
			    },
	...
	function withdrawal(suggstId) {
		...
		if (confirm('삭제 하시겠습니까?')) {
			$.ajax({
			    type : "POST",
			    url : "/admin/api/ess/notification/suggest/withdrawal",
			    data : formData,
			    processData: false,
			    contentType: false,
	...
	function registration() {
		...
		if (confirm('등록 하시겠습니까?')) {
			$.ajax({
			    type : "POST",
			    url : "/admin/api/ess/notification/suggest/registration",
			    data : formData,
			    processData: false,
			    contentType: false,
			    mimeType: 'multipart/form-data',
