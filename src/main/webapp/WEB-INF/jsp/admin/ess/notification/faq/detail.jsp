...
<script type='text/javascript'>
	...
	function getDetail() {
		...
		comAjax.setUrl("<c:url value='/admin/api/ess/notification/faq/search/detail'/>");
	...
	function modification() {
		...
		if (confirm('수정 하시겠습니까?')) {
			$.ajax({
			    type : "POST",
			    url : "/admin/api/ess/notification/faq/modification",
			    data : formData,
			    processData: false,
			    contentType: false,
			    ...
			    success : function(data) {
			        ...
			        if (jsonData.result == 1) {
			            alert("수정 되었습니다.");
			            location.href = "/admin/rdt/ess/notification/faq/searchList";
			        } else {
	...
	function withdrawal() {
		...
		if (confirm('삭제 하시겠습니까?')) {
			$.ajax({
			    type : "POST",
			    url : "/admin/api/ess/notification/faq/withdrawal",
			    data : formData,
			    processData: false,
			    contentType: false,
			    mimeType: 'multipart/form-data',
...
<div class="page-nation container">
	...
	<a href="/admin/rdt/ess/notification/faq/searchList">알림/정보</a><span class="route_icon"></span>
...
<!--리스트 검색 상단-->				
			<div class="sub-content-box bgc-white">	
                      ...
                      <div class="fr">
                          <a href="/admin/rdt/ess/notification/faq/searchList" class="gray_btn btn list_back_btn">목록</a>
