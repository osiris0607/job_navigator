...
<script type='text/javascript'>
	...
	function getCompanyDetail() {
		...
		comAjax.setUrl("<c:url value='/admin/api/solar/company/detail'/>");
	...
	function modification() {
		...
		if (confirm('수정 하시겠습니까?')) {
			$.ajax({
			    type : "POST",
			    url : "/admin/api/solar/company/modification",
			    data : formData,
			    processData: false,
			    contentType: false,
			    ...
			    success : function(data) {
			        ...
			        if (jsonData.result == 1) {
			            alert("수정 되었습니다.");
			            location.href = "/admin/rdt/solar/company/searchList";
			        } else {
	...
	function withdrawal() {
		if (confirm('삭제 하시겠습니까?')) {
			$.ajax({
			    type : "POST",
			    url : "/admin/api/solar/company/withdrawal",
...
<div class="page-nation container">
    ...
    <a href="/admin/rdt/solar/company/searchList">기업 관리</a><span class="route_icon"></span>
			...
			<form name="frm" id="frm">
                  ...
                  <table class="job_write">
                  	...
                  	<div class="upload_btn">
                        ...
                        <div class="fr">
                        	<a href="/admin/rdt/solar/company/searchList" class="gray_btn list_back_btn btn">목록</a>
