...
<script type='text/javascript'>
	...
	function getJobDetail() {
		...
		comAjax.setUrl("<c:url value='/admin/api/solar/job/detail'/>");
	...
	function getJobList() {
		var comAjax = new ComAjax();
		comAjax.setUrl("<c:url value='/admin/api/solar/job/all' />");
	...
	function getCompanyList() {
		var comAjax = new ComAjax();
		comAjax.setUrl("<c:url value='/admin/api/solar/company/all' />");
	...
	function getLicenseList() {
		var comAjax = new ComAjax();
		comAjax.setUrl("<c:url value='/admin/api/solar/notification/license/all' />");
	...
	function modification() {
		...
		if (confirm('수정 하시겠습니까?')) {
			$.ajax({
			    type : "POST",
			    url : "/admin/api/solar/job/modification",
			    data : formData,
			    processData: false,
			    contentType: false,
			    ...
			    success : function(data) {
			        ...
			        if (jsonData.result == 1) {
			            alert("수정 되었습니다.");
			            location.href = "/admin/rdt/solar/job/search";
			        } else {
	...
	function withdrawal() {
		if (confirm('삭제 하시겠습니까?')) {
			$.ajax({
			    type : "POST",
			    url : "/admin/api/solar/job/withdrawal",
...
<div class="page-nation container">
    ...
    <a href="/admin/rdt/solar/job/search">일자리</a><span class="route_icon"></span>
			...
			<div class="sub-content-box bgc-white">
			    <!--기본 정보-->
                   ...
                   <div class="job_retouch_btns-box">
                        ...
                        <div class="fr">
                            <a href="/admin/rdt/solar/job/search" class="gray_btn list_back_btn btn">목록</a>
