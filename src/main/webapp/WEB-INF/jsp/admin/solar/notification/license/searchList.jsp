...
<script type='text/javascript'>
	...
	function searchList(pageNo) {
		...
		comAjax.setUrl("<c:url value='/admin/api/solar/notification/license/search/paging' />");
	...
	function searchListCB(data) {
		...
		if (total == 0) {
			...
			$.each(data.result, function(key, value) {
				...
				str += "	<td><a href='/admin/rdt/solar/notification/license/detail?license_id=" + value.license_id + "'>" + value.kor_name + "</a></td>";
...
<!--                <h4 class="fl">현재 페이지</h4>
               ...
               <div class="fr education-center_table_top_seach">
                   ...
                   <a href="/admin/rdt/solar/notification/license/registration" class="btn blue_btn fr">등록</a>
               </div>
