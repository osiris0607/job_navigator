...
<script type='text/javascript'>
	...
	function getLicenseDetail() {
		...
		comAjax.setUrl("<c:url value='/admin/api/solar/notification/trend/search/detail'/>");
	...
	function modification() {
		...
		if (confirm('수정 하시겠습니까?')) {
			$.ajax({
			    type : "POST",
			    url : "/admin/api/solar/notification/trend/modification",
			    data : formData,
			    processData: false,
			    contentType: false,
	...
	function withdrawal() {
		...
		if (confirm('삭제 하시겠습니까?')) {
			$.ajax({
			    type : "POST",
			    url : "/admin/api/solar/notification/trend/withdrawal",
			    data : formData,
			    processData: false,
			    contentType: false,
			    mimeType: 'multipart/form-data',
