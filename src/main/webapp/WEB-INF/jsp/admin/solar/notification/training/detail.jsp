...
<script type='text/javascript'>
	...
	function getDetail() {
		...
		comAjax.setUrl("<c:url value='/admin/api/solar/notification/training/search/detail'/>");
	...
	function modification() {
		...
		if (confirm('수정 하시겠습니까?')) {
			$.ajax({
			    type : "POST",
			    url : "/admin/api/solar/notification/training/modification",
			    data : formData,
			    processData: false,
			    contentType: false,
	...
	function withdrawal() {
		...
		if (confirm('삭제 하시겠습니까?')) {
			$.ajax({
			    type : "POST",
			    url : "/admin/api/solar/notification/training/withdrawal",
			    data : formData,
			    processData: false,
			    contentType: false,
			    mimeType: 'multipart/form-data',
