         ...
         <li>
         	<a href="javascript:tabSelect('C0012', '/admin/rdt/ess/notification/trend/searchList');"><i class="fas fa-bullhorn"></i>알림/정보</a>
           	<ul class="arrow_box">
				...
				<li><a href="javascript:tabSelect('C0014', '/admin/rdt/ess/notification/online/searchList');">온라인 강의</a></li>
				<li><a href="javascript:tabSelect('C0015', '/admin/rdt/ess/notification/license/searchList');">자격증</a></li>
				<li><a href="javascript:tabSelect('C0016', '/admin/rdt/ess/notification/training/searchList');">훈련과정</a></li>
				<li><a href="javascript:tabSelect('C0017', '/admin/rdt/ess/notification/faq/searchList');">FAQ</a></li>
				<!-- <li><a href="javascript:tabSelect('C0016', '/admin/rdt/ess/notification/suggest/management');">건의하기</a></li> -->
			</ul>
         </li>
         <li>
         	<a href="javascript:tabSelect('C0018', '/admin/rdt/member/management');"><i class="fas fa-user-cog"></i>관리자</a>
			<ul class="arrow_box">
